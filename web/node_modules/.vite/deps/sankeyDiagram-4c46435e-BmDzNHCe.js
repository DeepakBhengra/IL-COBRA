...
import { Hn as require_dist, I as setDiagramTitle, N as setAccDescription, P as setAccTitle, R as setupGraphViewbox$1, Rn as select_default, Un as require_dayjs_min, _ as getConfig, d as defaultConfig, g as getAccTitle, h as getAccDescription, o as clear$1, s as common$1, y as getDiagramTitle } from "./mermaid-59c9be08-B2V2B2GS.js";
...
var draw = function(text, id, _version, diagObj) {
	...
	Sankey().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (showValues ? 15 : 0)).nodeAlign(nodeAlign).extent([[0, 0], [width, height]])(graph);
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
	...
	const link = svg.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", .5).selectAll(".link").data(graph.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply");
	...
	link.append("path").attr("d", sankeyLinkHorizontal_default()).attr("stroke", coloring).attr("stroke-width", (d) => Math.max(1, d.width));
...
//# sourceMappingURL=sankeyDiagram-4c46435e-BmDzNHCe.js.map