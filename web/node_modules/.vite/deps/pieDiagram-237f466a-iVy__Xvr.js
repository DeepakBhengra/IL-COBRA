...
import { D as parseFontSize, Hn as require_dist, I as setDiagramTitle, M as selectSvgElement, N as setAccDescription, P as setAccTitle, Qt as tau, T as log$1, Un as require_dayjs_min, _ as getConfig$1, a as cleanAndMerge, f as defaultConfig$2, g as getAccTitle, h as getAccDescription, j as sanitizeText$2, l as configureSvgSize, o as clear$1, y as getDiagramTitle } from "./mermaid-59c9be08-B2V2B2GS.js";
import { t as ordinal } from "./ordinal-CwuWvYe0.js";
import { n as constant_default } from "./path-B2YYvyHp.js";
...
var getConfig = () => structuredClone(config);
var clear = () => {
...
var draw = (text, id, _version, diagObj) => {
	...
	const legend = group.selectAll(".legend").data(color.domain()).enter().append("g").attr("class", "legend").attr("transform", (_datum, index) => {
		...
		return "translate(216," + (index * height2 - offset) + ")";
	});
	legend.append("rect").attr("width", LEGEND_RECT_SIZE).attr("height", LEGEND_RECT_SIZE).style("fill", color).style("stroke", color);
	legend.data(arcs).append("text").attr("x", 22).attr("y", LEGEND_RECT_SIZE - LEGEND_SPACING).text((datum) => {
		const { label, value } = datum.data;
		if (db2.getShowData()) return `${label} [${value}]`;
		return label;
	});
	const totalWidth = 512 + Math.max(...legend.selectAll("text").nodes().map((node) => (node == null ? void 0 : node.getBoundingClientRect().width) ?? 0));
...
//# sourceMappingURL=pieDiagram-237f466a-iVy__Xvr.js.map