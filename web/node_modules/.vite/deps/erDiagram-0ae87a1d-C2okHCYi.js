...
import { Hn as require_dist, I as setDiagramTitle, N as setAccDescription, O as parseGenericTypes, P as setAccTitle, Rn as select_default, Rt as basis_default, T as log$1, Un as require_dayjs_min, _ as getConfig, g as getAccTitle, h as getAccDescription, l as configureSvgSize, o as clear$1, y as getDiagramTitle, z as utils } from "./mermaid-59c9be08-B2V2B2GS.js";
...
var parser = function() {
	var o = function(k, v, o2, l) {
		...
		27,
		28
	], $V1 = [1, 10], $V2 = [1, 11], $V3 = [1, 12], $V4 = [1, 13], $V5 = [1, 14], $V6 = [1, 15], $V7 = [1, 21], $V8 = [1, 22], $V9 = [1, 23], $Va = [1, 24], $Vb = [1, 25], $Vc = [
		6,
		8,
		10,
		13,
...
var drawAttributes = (groupNode, entityTextNode, attributes) => {
	...
	const attrFontSize = conf.fontSize * .85;
...
var drawEntities = function(svgNode, entities2, graph) {
	...
	keys.forEach(function(entityName) {
		...
		const { width: entityWidth, height: entityHeight } = drawAttributes(groupNode, groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", getConfig().fontFamily).style("font-size", conf.fontSize + "px").text(entities2[entityName].alias ?? entityName), entities2[entityName].attributes);
		const rectBBox = groupNode.insert("rect", "#" + textId).classed("er entityBox", true).attr("x", 0).attr("y", 0).attr("width", entityWidth).attr("height", entityHeight).node().getBBox();
...
var addRelationships = function(relationships2, g) {
	relationships2.forEach(function(r) {
		g.setEdge(entityNameIds.get(r.entityA), entityNameIds.get(r.entityB), { relationship: r }, getEdgeName(r));
	});
...
var drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
	...
	const labelBBox = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", getConfig().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA).node().getBBox();
...
function generateId(str = "", prefix = "") {
	...
	return `${strWithHyphen(prefix)}${strWithHyphen(simplifiedStr)}${v5(str, MERMAID_ERDIAGRAM_UUID)}`;
}
...
//# sourceMappingURL=erDiagram-0ae87a1d-C2okHCYi.js.map