import { I as setDiagramTitle, N as setAccDescription, P as setAccTitle, Rn as select_default, T as log$1, _ as getConfig, d as defaultConfig, g as getAccTitle, h as getAccDescription, o as clear$1, s as common$1, y as getDiagramTitle, z as utils } from "./mermaid-59c9be08-B2V2B2GS.js";
//#region node_modules/mermaid/dist/flowDb-99855667.js
var parser = function() {
	var o = function(k, v, o2, l) {
		...
		120,
		121
	], $V4 = [2, 2], $V5 = [1, 13], $V6 = [1, 14], $V7 = [1, 15], $V8 = [1, 16], $V9 = [1, 23], $Va = [1, 25], $Vb = [1, 26], $Vc = [1, 27], $Vd = [1, 49], $Ve = [1, 48], $Vf = [1, 29], $Vg = [1, 30], $Vh = [1, 31], $Vi = [1, 32], $Vj = [1, 33], $Vk = [1, 44], $Vl = [1, 46], $Vm = [1, 42], $Vn = [1, 47], $Vo = [1, 43], $Vp = [1, 50], $Vq = [1, 45], $Vr = [1, 51], $Vs = [1, 52], $Vt = [1, 34], $Vu = [1, 35], $Vv = [1, 36], $Vw = [1, 37], $Vx = [1, 57], $Vy = [
		1,
		8,
		9,
		10,
		...
		120,
		121
	], $Vz = [1, 61], $VA = [1, 60], $VB = [1, 62], $VC = [
		8,
		9,
		11,
		73,
		75
	], $VD = [1, 88], $VE = [1, 93], $VF = [1, 92], $VG = [1, 89], $VH = [1, 85], $VI = [1, 91], $VJ = [1, 87], $VK = [1, 94], $VL = [1, 90], $VM = [1, 95], $VN = [1, 86], $VO = [
		8,
		9,
		10,
		11,
		...
		112,
		113
	], $VT = [1, 121], $VU = [1, 120], $VV = [1, 128], $VW = [1, 142], $VX = [1, 143], $VY = [1, 144], $VZ = [1, 145], $V_ = [1, 130], $V$ = [1, 132], $V01 = [1, 136], $V11 = [1, 137], $V21 = [1, 138], $V31 = [1, 139], $V41 = [1, 140], $V51 = [1, 141], $V61 = [1, 146], $V71 = [1, 147], $V81 = [1, 126], $V91 = [1, 127], $Va1 = [1, 134], $Vb1 = [1, 129], $Vc1 = [1, 133], $Vd1 = [1, 131], $Ve1 = [
		8,
		9,
		10,
		11,
		...
		112,
		113
	], $Vi1 = [1, 169], $Vj1 = [1, 165], $Vk1 = [1, 166], $Vl1 = [1, 170], $Vm1 = [1, 167], $Vn1 = [1, 168], $Vo1 = [
		75,
		113,
		116
	], $Vp1 = [
		...
		114,
		115
	], $Vs1 = [1, 235], $Vt1 = [1, 233], $Vu1 = [1, 237], $Vv1 = [1, 231], $Vw1 = [1, 232], $Vx1 = [1, 234], $Vy1 = [1, 236], $Vz1 = [1, 238], $VA1 = [1, 255], $VB1 = [
		8,
		9,
		11,
		103
	...
	var parser2 = {
		...
		table: [
			...
			{ 77: [1, 201] },
			o($Vg1, [2, 102], { 10: [1, 202] }),
			o($Vg1, [2, 104], { 10: [1, 203] }),
			{ 77: [1, 204] },
			o($Vh1, [2, 177]),
			{
				77: [1, 205],
...
var lookUpDomId = function(id) {
	...
	for (const vertexKey of vertexKeys) if (vertices[vertexKey].id === id) return vertices[vertexKey].domId;
	return id;
};
...
var addSingleLink = function(_start, _end, type) {
	...
	if (edges.length < (config.maxEdges ?? 500)) {
		...
		edges.push(edge);
	} else throw new Error(`Edge limit exceeded. ${edges.length} edges found, but the limit is ${config.maxEdges}.
...
var updateLink = function(positions, style) {
	positions.forEach(function(pos) {
		if (pos >= edges.length) throw new Error(`The index ${pos} for linkStyle is out of bounds. Valid indices for linkStyle are between 0 and ${edges.length - 1}. (Help: Ensure that the index is within the range of existing edges.)`);
		if (pos === "default") edges.defaultStyle = style;
		else {
			if (utils.isSubstringInArray("fill", style) === -1) style.push("fill:none");
...
var addSubGraph = function(_id, list, _title) {
	...
	function uniq(a) {
		...
		let dir2;
		return {
			nodeList: a.filter(function(item) {
...
var getPosForId = function(id) {
	for (const [i, subGraph] of subGraphs.entries()) if (subGraph.id === id) return i;
	return -1;
};
var secCount = -1;
var posCrossRef = [];
...
var exists = (allSgs, _id) => {
	let res = false;
	allSgs.forEach((sg) => {
		if (sg.nodes.indexOf(_id) >= 0) res = true;
	});
	return res;
};
...
var db = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	addClass,
	addLink,
	addSingleLink,
...
//#endregion
export { flowDb as n, parser$1 as r, db as t };

//# sourceMappingURL=flowDb-99855667-wxUGj6_j.js.map