...
import { B as wrapLabel, Hn as require_dist, N as setAccDescription, P as setAccTitle, Rn as select_default, T as log$1, Un as require_dayjs_min, _ as getConfig, g as getAccTitle, h as getAccDescription, i as calculateTextWidth, j as sanitizeText$2, l as configureSvgSize, r as calculateTextHeight, s as common$1, t as assignWithDepth$1 } from "./mermaid-59c9be08-B2V2B2GS.js";
import { i as drawRect$1, o as getNoteRect } from "./svgDrawCommon-70a69047-BCzqiMOK.js";
//#region node_modules/mermaid/dist/c4Diagram-9e17e874.js
...
var parser = function() {
	var o = function(k, v, o2, l) {
		...
		73,
		74
	], $VK = [1, 82], $VL = [1, 83], $VM = [1, 84], $VN = [1, 85], $VO = [
		12,
		14,
		42
	], $VP = [
...
var setC4Type = function(c4TypeParam) {
	c4Type = sanitizeText$2(c4TypeParam, getConfig());
};
var addRel = function(type, from, to, label, techn, descr, sprite, tags, link) {
	...
	if (techn === void 0 || techn === null) rel.techn = { text: "" };
	else if (typeof techn === "object") {
		let [key, value] = Object.entries(techn)[0];
		rel[key] = { text: value };
	} else rel.techn = { text: techn };
	if (descr === void 0 || descr === null) rel.descr = { text: "" };
	else if (typeof descr === "object") {
		let [key, value] = Object.entries(descr)[0];
		rel[key] = { text: value };
	} else rel.descr = { text: descr };
...
var addPersonOrSystem = function(typeC4Shape, alias, label, descr, sprite, tags, link) {
	...
	if (label === void 0 || label === null) personOrSystem.label = { text: "" };
	else personOrSystem.label = { text: label };
	if (descr === void 0 || descr === null) personOrSystem.descr = { text: "" };
	else if (typeof descr === "object") {
		let [key, value] = Object.entries(descr)[0];
		personOrSystem[key] = { text: value };
	} else personOrSystem.descr = { text: descr };
	if (typeof sprite === "object") {
		let [key, value] = Object.entries(sprite)[0];
...
var addContainer = function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
	...
	if (label === void 0 || label === null) container.label = { text: "" };
	else container.label = { text: label };
	if (techn === void 0 || techn === null) container.techn = { text: "" };
	else if (typeof techn === "object") {
		let [key, value] = Object.entries(techn)[0];
		container[key] = { text: value };
	} else container.techn = { text: techn };
	if (descr === void 0 || descr === null) container.descr = { text: "" };
	else if (typeof descr === "object") {
		let [key, value] = Object.entries(descr)[0];
		container[key] = { text: value };
	} else container.descr = { text: descr };
	if (typeof sprite === "object") {
		let [key, value] = Object.entries(sprite)[0];
		container[key] = value;
...
var addComponent = function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
	...
	if (label === void 0 || label === null) component.label = { text: "" };
	else component.label = { text: label };
	if (techn === void 0 || techn === null) component.techn = { text: "" };
	else if (typeof techn === "object") {
		let [key, value] = Object.entries(techn)[0];
		component[key] = { text: value };
	} else component.techn = { text: techn };
	if (descr === void 0 || descr === null) component.descr = { text: "" };
	else if (typeof descr === "object") {
		let [key, value] = Object.entries(descr)[0];
		component[key] = { text: value };
	} else component.descr = { text: descr };
	if (typeof sprite === "object") {
		let [key, value] = Object.entries(sprite)[0];
		component[key] = value;
...
var addPersonOrSystemBoundary = function(alias, label, type, tags, link) {
	...
	if (label === void 0 || label === null) boundary.label = { text: "" };
	else boundary.label = { text: label };
	if (type === void 0 || type === null) boundary.type = { text: "system" };
	else if (typeof type === "object") {
		let [key, value] = Object.entries(type)[0];
		boundary[key] = { text: value };
	} else boundary.type = { text: type };
	if (typeof tags === "object") {
		let [key, value] = Object.entries(tags)[0];
		boundary[key] = value;
...
var addContainerBoundary = function(alias, label, type, tags, link) {
	...
	if (type === void 0 || type === null) boundary.type = { text: "container" };
	else if (typeof type === "object") {
		let [key, value] = Object.entries(type)[0];
		boundary[key] = { text: value };
	} else boundary.type = { text: type };
...
var addDeploymentNode = function(nodeType, alias, label, type, descr, sprite, tags, link) {
	...
	if (type === void 0 || type === null) boundary.type = { text: "node" };
	else if (typeof type === "object") {
		let [key, value] = Object.entries(type)[0];
		boundary[key] = { text: value };
	} else boundary.type = { text: type };
	if (descr === void 0 || descr === null) boundary.descr = { text: "" };
	else if (typeof descr === "object") {
		let [key, value] = Object.entries(descr)[0];
		boundary[key] = { text: value };
	} else boundary.descr = { text: descr };
	if (typeof tags === "object") {
		let [key, value] = Object.entries(tags)[0];
		boundary[key] = value;
	} else boundary.tags = tags;
...
var updateLayoutConfig = function(typeC4Shape, c4ShapeInRowParam, c4BoundaryInRowParam) {
	...
	if (c4ShapeInRowValue >= 1) c4ShapeInRow$1 = c4ShapeInRowValue;
	if (c4BoundaryInRowValue >= 1) c4BoundaryInRow$1 = c4BoundaryInRowValue;
};
...
var setTitle = function(txt) {
	title = sanitizeText$2(txt, getConfig());
};
var db = {
	addPersonOrSystem,
...
var drawImage = function(elem, width, height, x, y, link) {
	...
	imageElem.attr("x", x);
	imageElem.attr("y", y);
	let sanitizedLink = link.startsWith("data:image/png;base64") ? link : (0, import_dist.sanitizeUrl)(link);
...
var drawRels$1 = (elem, rels2, conf2) => {
	...
	for (let rel of rels2) {
		...
		if (i === 0) {
			...
			if (rel.type !== "rel_b") line.attr("marker-end", "url(#arrowhead)");
			if (rel.type === "birel" || rel.type === "rel_b") line.attr("marker-start", "url(#arrowend)");
			i = -1;
		} else {
...
var drawBoundary$1 = function(elem, boundary, conf2) {
	...
	if (boundary.nodeType) attrsValue = { "stroke-width": 1 };
	drawRect(boundaryElem, {
		x: boundary.x,
		y: boundary.y,
		fill: fillColor,
		stroke: strokeColor,
...
var drawC4Shape = function(elem, c4Shape, conf2) {
	...
	textFontConf.fontColor = fontColor;
	if (c4Shape.techn && ((_a = c4Shape.techn) == null ? void 0 : _a.text) !== "") _drawTextCandidateFunc(conf2)(c4Shape.techn.text, c4ShapeElem, c4Shape.x, c4Shape.y + c4Shape.techn.Y, c4Shape.width, c4Shape.height, {
		fill: fontColor,
		"font-style": "italic"
	}, textFontConf);
...
var insertArrowCrossHead = function(elem) {
	const marker = elem.append("defs").append("marker").attr("id", "crosshead").attr("markerWidth", 15).attr("markerHeight", 8).attr("orient", "auto").attr("refX", 16).attr("refY", 4);
...
var drawBoundary = function(diagram2, boundary, bounds) {
	...
	calcC4ShapeTextWH("label", boundary, boundaryTextWrap, boundaryLabelConf, calculateTextWidth(boundary.label.text, boundaryLabelConf));
...
var drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
	...
	for (const c4ShapeKey of c4ShapeKeys) {
		...
		if (c4Shape.type && c4Shape.type.text !== "") {
			...
			calcC4ShapeTextWH("type", c4Shape, c4ShapeTextWrap, c4ShapeFont(conf, c4Shape.typeC4Shape.text), textLimitWidth);
			c4Shape["type"].Y = Y + 5;
			Y = c4Shape["type"].Y + c4Shape["type"].height;
		} else if (c4Shape.techn && c4Shape.techn.text !== "") {
			c4Shape.techn.text = "[" + c4Shape.techn.text + "]";
			calcC4ShapeTextWH("techn", c4Shape, c4ShapeTextWrap, c4ShapeFont(conf, c4Shape.techn.text), textLimitWidth);
			c4Shape["techn"].Y = Y + 5;
		...
		if (c4Shape.descr && c4Shape.descr.text !== "") {
			calcC4ShapeTextWH("descr", c4Shape, c4ShapeTextWrap, c4ShapeFont(conf, c4Shape.typeC4Shape.text), textLimitWidth);
...
var getIntersectPoint = function(fromNode, endPoint) {
	...
	if (x1 > x2 && y1 < y2) if (fromDYX >= tanDYX) returnPoint = new Point(x1, fromCenterY + tanDYX * fromNode.width / 2);
	else returnPoint = new Point(fromCenterX - dx / dy * fromNode.height / 2, y1 + fromNode.height);
	else if (x1 < x2 && y1 < y2) if (fromDYX >= tanDYX) returnPoint = new Point(x1 + fromNode.width, fromCenterY + tanDYX * fromNode.width / 2);
	else returnPoint = new Point(fromCenterX + dx / dy * fromNode.height / 2, y1 + fromNode.height);
	else if (x1 < x2 && y1 > y2) if (fromDYX >= tanDYX) returnPoint = new Point(x1 + fromNode.width, fromCenterY - tanDYX * fromNode.width / 2);
	else returnPoint = new Point(fromCenterX + fromNode.height / 2 * dx / dy, y1);
	else if (x1 > x2 && y1 > y2) if (fromDYX >= tanDYX) returnPoint = new Point(x1, fromCenterY - fromNode.width / 2 * tanDYX);
	else returnPoint = new Point(fromCenterX - fromNode.height / 2 * dx / dy, y1);
	return returnPoint;
};
var getIntersectPoints = function(fromNode, endNode) {
	...
	return {
		startPoint,
		endPoint: getIntersectPoint(endNode, endIntersectPoint)
	};
};
var drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
	...
	for (let rel of rels2) {
		...
		if (diagObj.db.getC4Type() === "C4Dynamic") rel.label.text = i + ": " + rel.label.text;
		...
		let points = getIntersectPoints(getC4ShapeObj(rel.from), getC4ShapeObj(rel.to));
...
function drawInsideBoundary(diagram2, parentBoundaryAlias, parentBounds, currentBoundaries, diagObj) {
	...
	for (let [i, currentBoundary] of currentBoundaries.entries()) {
		...
		if (currentBoundary.type && currentBoundary.type.text !== "") {
			...
			calcC4ShapeTextWH("type", currentBoundary, currentBoundaryTextWrap, boundaryFont(conf), currentBounds.data.widthLimit);
		...
		if (currentBoundary.alias !== "global") drawBoundary(diagram2, currentBoundary, currentBounds);
...
var draw = function(_text, id, _version, diagObj) {
	...
	drawInsideBoundary(diagram2, "", screenBounds, diagObj.db.getBoundarys(""), diagObj);
...
//# sourceMappingURL=c4Diagram-9e17e874-dqOuBIRG.js.map