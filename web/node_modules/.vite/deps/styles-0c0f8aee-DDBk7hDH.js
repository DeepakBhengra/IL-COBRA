import { I as setDiagramTitle, N as setAccDescription, P as setAccTitle, T as log$1, _ as getConfig, g as getAccTitle, h as getAccDescription, m as generateId, o as clear$1, s as common$1, y as getDiagramTitle } from "./mermaid-59c9be08-B2V2B2GS.js";
//#region node_modules/mermaid/dist/styles-0c0f8aee.js
var parser = function() {
	var o = function(k, v, o2, l) {
		for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v);
		return o2;
	}, $V0 = [1, 2], $V1 = [1, 3], $V2 = [1, 4], $V3 = [2, 4], $V4 = [1, 9], $V5 = [1, 11], $V6 = [1, 15], $V7 = [1, 16], $V8 = [1, 17], $V9 = [1, 18], $Va = [1, 30], $Vb = [1, 19], $Vc = [1, 20], $Vd = [1, 21], $Ve = [1, 22], $Vf = [1, 23], $Vg = [1, 25], $Vh = [1, 26], $Vi = [1, 27], $Vj = [1, 28], $Vk = [1, 29], $Vl = [1, 32], $Vm = [1, 33], $Vn = [1, 34], $Vo = [1, 35], $Vp = [1, 31], $Vq = [
		1,
		4,
		5,
		15,
...
var docTranslator = (parent, node, first) => {
	if (node.stmt === "relation") {
		...
		if (node.doc) {
			...
			let currentDoc = [];
			let i;
			for (i = 0; i < node.doc.length; i++) if (node.doc[i].type === "divider") {
...
var addState = function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles2 = null, textStyles = null) {
	...
	if (note) {
		...
		currentDocument.states[trimmedId].note.text = common$1.sanitizeText(currentDocument.states[trimmedId].note.text, getConfig());
	}
	if (classes2) {
		log$1.info("Setting state classes", trimmedId, classes2);
		(typeof classes2 === "string" ? [classes2] : classes2).forEach((cssClass) => setCssClass(trimmedId, cssClass.trim()));
	}
	if (styles2) {
		log$1.info("Setting state styles", trimmedId, styles2);
		(typeof styles2 === "string" ? [styles2] : styles2).forEach((style) => setStyle(trimmedId, style.trim()));
	}
	if (textStyles) {
		log$1.info("Setting state styles", trimmedId, styles2);
		(typeof textStyles === "string" ? [textStyles] : textStyles).forEach((textStyle) => setTextStyle(trimmedId, textStyle.trim()));
	}
};
var clear = function(saveCommon) {
	documents = { root: newDoc() };
	currentDocument = documents.root;
	startEndCount = 0;
	classes = newClassesList();
	if (!saveCommon) clear$1();
};
...
//#endregion
export { db as a, STMT_STATE as i, DIVIDER_TYPE as n, parser$1 as o, STMT_RELATION as r, styles as s, DEFAULT_STATE_TYPE as t };

//# sourceMappingURL=styles-0c0f8aee-DDBk7hDH.js.map