import { A as renderKatexSanitized, Bn as root, C as interpolateToCurve, Dt as isFunction, Ft as rgba, R as setupGraphViewbox$1, Rn as select_default, T as log$1, Vn as array, _ as getConfig, b as getStylesFromArray, ot as isPlainObject, p as evaluate, s as common$1, z as utils, zn as Selection, zt as linear_default } from "./mermaid-59c9be08-B2V2B2GS.js";
import { t as channel } from "./channel-BT2qUpdH.js";
import { t as Graph } from "./graphlib-Di4BP18U.js";
import { t as render } from "./index-bf99f535-B5Yx1xR_.js";
//#region node_modules/d3-selection/src/selectAll.js
function selectAll_default(selector) {
	return typeof selector === "string" ? new Selection([document.querySelectorAll(selector)], [document.documentElement]) : new Selection([array(selector)], root);
}
//#endregion
//#region node_modules/dagre-d3-es/src/dagre-js/util.js
...
function applyTransition(selection, g) {
	...
	if (isPlainObject(graph)) {
		...
		if (isFunction(transition)) return transition(selection);
	}
	return selection;
}
//#endregion
//#region node_modules/dagre-d3-es/src/dagre-js/label/add-html-label.js
...
//#endregion
//#region node_modules/mermaid/dist/styles-38506eb2.js
var conf = {};
...
var addVertices = async function(vert, g, svgId, root, doc, diagObj) {
	...
	for (const id of keys) {
		...
		if (vertex.labelType === "markdown") log$1.info("vertex", vertex, vertex.labelType);
		else if (evaluate(getConfig().flowchart.htmlLabels)) {
			vertexNode = addHtmlLabel(svg, { label: vertexText }).node();
...
var addEdges = async function(edges, g, diagObj) {
	...
	for (const edge of edges) {
		...
		switch (edge.type) {
			case "double_arrow_cross": edgeData.arrowTypeStart = "arrow_cross";
			case "arrow_cross":
				edgeData.arrowTypeEnd = "arrow_cross";
				break;
			case "double_arrow_point": edgeData.arrowTypeStart = "arrow_point";
			case "arrow_point":
				edgeData.arrowTypeEnd = "arrow_point";
				break;
			case "double_arrow_circle": edgeData.arrowTypeStart = "arrow_circle";
			case "arrow_circle":
		...
		edgeData.label = await renderKatexSanitized(edge.text.replace(common$1.lineBreakRegex, "\n"), getConfig());
...
//#endregion
export { applyStyle as a, isSubgraph as c, applyClass as i, selectAll_default as l, flowStyles as n, applyTransition as o, addHtmlLabel as r, edgeToId as s, flowRendererV2 as t };

//# sourceMappingURL=styles-38506eb2-DnJXt0Wl.js.map