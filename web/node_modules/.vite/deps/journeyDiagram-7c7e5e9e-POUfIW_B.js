...
import { Hn as require_dist, I as setDiagramTitle, N as setAccDescription, P as setAccTitle, Rn as select_default, Un as require_dayjs_min, _ as getConfig, g as getAccTitle, h as getAccDescription, l as configureSvgSize, o as clear$1, y as getDiagramTitle } from "./mermaid-59c9be08-B2V2B2GS.js";
import { t as arc_default } from "./arc-zOgpRmFV.js";
import { a as drawText$1, i as drawRect$1, o as getNoteRect, t as drawBackgroundRect$1 } from "./svgDrawCommon-70a69047-BCzqiMOK.js";
require_dayjs_min();
require_dist();
var parser = function() {
	var o = function(k, v, o2, l) {
		...
		17,
		18
	], $V1 = [1, 9], $V2 = [1, 10], $V3 = [1, 11], $V4 = [1, 12], $V5 = [1, 13], $V6 = [1, 14];
	var parser2 = {
...
var updateActors = function() {
	...
	return [...new Set(tempActors)].sort();
};
...
var setConf = function(cnf) {
	Object.keys(cnf).forEach(function(key) {
		conf[key] = cnf[key];
	});
};
var actors = {};
...
var drawTasks = function(diagram2, tasks2, verticalPos) {
	const conf2 = getConfig().journey;
	let lastSection = "";
	const taskPos = verticalPos + (conf2.height * 2 + conf2.diagramMarginY);
	let sectionNumber = 0;
	let fill = "#CCC";
	let colour = "black";
	let num = 0;
	for (const [i, task] of tasks2.entries()) {
		if (lastSection !== task.section) {
			...
			for (let taskIndex = i; taskIndex < tasks2.length; taskIndex++) if (tasks2[taskIndex].section == currentSection2) taskInSectionCount = taskInSectionCount + 1;
			else break;
			const section = {
...
//# sourceMappingURL=journeyDiagram-7c7e5e9e-POUfIW_B.js.map