import { i as __toESM, n as __exportAll, t as __commonJSMin } from "./chunk-B4lejLz5.js";
import { T as log$1, Wn as dedent$1, j as sanitizeText$2, u as decodeEntities, v as getConfig$1 } from "./mermaid-59c9be08-B2V2B2GS.js";
			...
			while (otherIndex--) {
				...
				if (otherEvent[1].type === types.lineEnding || otherEvent[1].type === types.lineEndingBlank) {
					if (otherEvent[0] === "enter") {
						if (lineIndex) events[lineIndex][1].type = types.lineEndingBlank;
...
function tokenizeListContinuation(effects, ok$4, nok) {
	...
	function notInCurrentItem(code) {
		...
		self.interrupt = void 0;
		ok(self.parser.constructs.disable.null, "expected `disable.null` to be populated");
		return factorySpace(effects, effects.attempt(list, ok$4, nok), types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize)(code);
	}
}
/**
* @type {Tokenizer}
	...
	*/
	function prepareList(events, start, length) {
		...
		while (++index <= length) {
			...
			} else if (event[1].type === types.linePrefix || event[1].type === types.listItemValue || event[1].type === types.listItemMarker || event[1].type === types.listItemPrefix || event[1].type === types.listItemPrefixWhitespace) {} else atMarker = void 0;
...
function preprocessMarkdown(markdown) {
	return dedent$1(markdown.replace(/\n{2,}/g, "\n"));
}
...
function createFormattedText(width, g, structuredText, addBackground = false) {
	...
	if (addBackground) {
		...
		const padding = 2;
		bkg.attr("x", -2).attr("y", -2).attr("width", bbox.width + 2 * padding).attr("height", bbox.height + 2 * padding);
...
var createText = (el, text = "", { style = "", isTitle = false, classes = "", useHtmlLabels = true, isNode = true, width = 200, addSvgBackground = false } = {}) => {
...
//#endregion
export { createText as n, computeDimensionOfText as t };

//# sourceMappingURL=createText-31840e8c-EA-kfJEy.js.map